...
import cn.edu.tsinghua.iotdb.kairosdb.http.rest.json.*;
...
public class MetricsResource {
    ...
    @Path("/datapoints")
    @Deprecated public Response addGzip(InputStream gzip)
    {
    ...
    public Response getVersion() {
        Response.ResponseBuilder responseBuilder = Response.status(Response.Status.OK).entity("{\"version\": \"1.0.0\"}\n");
